...
export default class ChoreoTreeWalker {
  ...
  handleDeferred() {
    ...
    handleSubProcess(subProcess, context) {
    this.handleFlowElementsContainer(subProcess, context);
    this.handleArtifacts(subProcess.artifacts, context);
  }
  ...
  handleFlowNode(flowNode, parentShape) {
    ...
    if (is(flowNode, 'bpmn:SubProcess')) {
      this.handleSubProcess(flowNode, flowNodeShape || parentShape);
    }
  }
